...
_lr_productions = [
  ...
  ('block -> constDecl varDecl procDecl statement','block',4,'p_block','analizadorSintactico.py',28),
  ('constDecl -> CONST constAssignmentList SEMMICOLOM','constDecl',3,'p_constDecl','analizadorSintactico.py',32),
  ('constDecl -> empty','constDecl',1,'p_constDeclEmpty','analizadorSintactico.py',37),
  ('constAssignmentList -> ID ASSIGN NUMBER','constAssignmentList',3,'p_constAssignmentList1','analizadorSintactico.py',42),
  ...
  ('varDecl -> VAR identList SEMMICOLOM','varDecl',3,'p_varDecl1','analizadorSintactico.py',50),
  ('varDecl -> empty','varDecl',1,'p_varDeclEmpty','analizadorSintactico.py',54),
  ('identList -> ID','identList',1,'p_identList1','analizadorSintactico.py',58),
  ('identList -> identList COMMA ID','identList',3,'p_identList2','analizadorSintactico.py',62),
  ('procDecl -> procDecl PROCEDURE ID SEMMICOLOM block SEMMICOLOM','procDecl',6,'p_procDecl1','analizadorSintactico.py',66),
  ('procDecl -> empty','procDecl',1,'p_procDeclEmpty','analizadorSintactico.py',70),
  ('statement -> ID UPDATE expression','statement',3,'p_statement1','analizadorSintactico.py',74),
  ('statement -> CALL ID','statement',2,'p_statement2','analizadorSintactico.py',78),
  ('statement -> BEGIN statementList END','statement',3,'p_statement3','analizadorSintactico.py',82),
  ('statement -> IF condition THEN statement','statement',4,'p_statement4','analizadorSintactico.py',86),
  ('statement -> WHILE condition DO statement','statement',4,'p_statement5','analizadorSintactico.py',90),
  ('statement -> empty','statement',1,'p_statementEmpty','analizadorSintactico.py',94),
  ('statementList -> statement','statementList',1,'p_statementList1','analizadorSintactico.py',98),
  ('statementList -> statementList SEMMICOLOM statement','statementList',3,'p_statementList2','analizadorSintactico.py',102),
  ('condition -> ODD expression','condition',2,'p_condition1','analizadorSintactico.py',106),
  ('condition -> expression relation expression','condition',3,'p_condition2','analizadorSintactico.py',110),
  ('relation -> ASSIGN','relation',1,'p_relation1','analizadorSintactico.py',114),
  ('relation -> NE','relation',1,'p_relation2','analizadorSintactico.py',118),
  ('relation -> LT','relation',1,'p_relation3','analizadorSintactico.py',122),
  ('relation -> GT','relation',1,'p_relation4','analizadorSintactico.py',126),
  ('relation -> LTE','relation',1,'p_relation5','analizadorSintactico.py',130),
  ('relation -> GTE','relation',1,'p_relation6','analizadorSintactico.py',134),
  ...
  ('addingOperator -> PLUS','addingOperator',1,'p_addingOperator1','analizadorSintactico.py',150),
  ...
  ('multiplyingOperator -> TIMES','multiplyingOperator',1,'p_multiplyingOperator1','analizadorSintactico.py',166),
  ('multiplyingOperator -> DIVIDE','multiplyingOperator',1,'p_multiplyingOperator2','analizadorSintactico.py',170),
  ('factor -> ID','factor',1,'p_factor1','analizadorSintactico.py',174),
  ('factor -> NUMBER','factor',1,'p_factor2','analizadorSintactico.py',178),
  ('factor -> LPARENT expression RPARENT','factor',3,'p_factor3','analizadorSintactico.py',182),
  ('empty -> <empty>','empty',0,'p_empty','analizadorSintactico.py',186),
]
